package biz.advanceitgroup.taxirideserver.authentification.securities.oauth2.user;
...
*/
  ...
  public Collection<? extends GrantedAuthority> getAuthorities() {
    ...
    public CustomUserDetails(String phoneNumber2, String email2, List<GrantedAuthority> authorities2) {
    ...
    // Social user autoritiies
    public static CustomUserDetails createSocial(Users user) {
