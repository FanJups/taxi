...
public class VehiclePicture extends MainEntity {
    ...
    private String vehicle; // Le véhicule possédant l'image en question

    public VehiclePicture(String vehicle, Integer pictureNumber, String pictureURL, String pictureMimeType, String username) {
